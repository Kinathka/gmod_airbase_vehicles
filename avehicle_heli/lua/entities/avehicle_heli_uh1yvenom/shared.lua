...
ENT.PrintName		= "Heli UH1Y Venom"
ENT.Author			= "Warkanum"
ENT.Category		= "AVehicles"
ENT.EntityName 		= "avehicle_heli_uh1yvenom"
ENT.Spawnable		= true
...
ENT.AVHardPoints = {
	...
	{id=2,kind=AVehicles.Types.HARDPOINT_AIMABLE,pos=Vector(-5, -60, 45),ang=Angle(0,-90,0),desc="Passenger right aimable mount.",pod=2}, --Force hp to pod 2
	{id=3,kind=AVehicles.Types.HARDPOINT_AIMABLE,pos=Vector(-5, 60, 45),ang=Angle(0,-90,0),desc="Passenger left aimable mount.",pod=3}, --Force hp to pod 3
	{id=4,kind=AVehicles.Types.HARDPOINT_UNIVERSAL,pos=Vector(-5, 57, 32),ang=Angle(0,0,0),desc="Bottom left static universal mount."},
	{id=5,kind=AVehicles.Types.HARDPOINT_UNIVERSAL,pos=Vector(-5, -57, 32),ang=Angle(0,0,0),desc="Bottom right static universal mount."},

	{id=6,kind=AVehicles.Types.HARDPOINT_SUPPORT,pos=Vector(50, 47,6),ang=Angle(0,0,0),desc="Support front left"}, 
	{id=7,kind=AVehicles.Types.HARDPOINT_SUPPORT,pos=Vector(50, -47,6),ang=Angle(0,0,0),desc="Support front right"},
	{id=8,kind=AVehicles.Types.HARDPOINT_SUPPORT,pos=Vector(-72, 47,11),ang=Angle(0,0,0),desc="Support back left"},
	{id=9,kind=AVehicles.Types.HARDPOINT_SUPPORT,pos=Vector(-72, -47,11),ang=Angle(0,0,0),desc="Support back right"}, 

	{id=10,kind=AVehicles.Types.HARDPOINT_HOOK,pos=Vector(-2.6, 0,19),ang=Angle(0,0,0),desc="Hook, Pickup mount"},
...
ENT.PodPositions[0].Position = Vector(103,-21,48)
ENT.PodDesc[0] = {}
...
ENT.PodPositions[1].Position = Vector(103,21,48)
ENT.PodDesc[1] = {}
...
ENT.PodPositions[2].Position = Vector(3,-34,45)
ENT.PodDesc[2] = {}
...
ENT.PodPositions[3].Position = Vector(3,34,45)
ENT.PodDesc[3] = {}
...
ENT.PodPositions[4].Position = Vector(-23,-33,43)
ENT.PodDesc[4] = {}
...
ENT.PodPositions[5].Position = Vector(-23,33,43)
ENT.PodDesc[5] = {}
...
ENT.PodPositions[6].Position = Vector(47,-26,45)
ENT.PodDesc[6] = {}
...
ENT.PodPositions[7].Position = Vector(47,26,45)
ENT.PodDesc[7] = {}
...
ENT.PodPositions[8].Position = Vector(22,-21,45)
ENT.PodDesc[8] = {}
...
ENT.PodPositions[9].Position = Vector(22,0,45) 
ENT.PodDesc[9] = {}
...
ENT.PodPositions[10].Position = Vector(22,21,45)
ENT.PodDesc[10] = {}
...
ENT.SimEngine.UpDownSpeed       = 14 -- How fast the heli goes up/down
...
------------------------------------------------------------------------------------Models-----------------------------------------------------------------------------
ENT.Models = {
				Base="models/Flyboi/UH1YVenom/uh1yvenom_fb.mdl",
				RotorBase="models/Flyboi/UH1YVenom/venomrotorm_fb.mdl",
				RotorTail="models/Flyboi/UH1YVenom/venomrotort_fb.mdl",
			}
ENT.GibsModels = {
...
util.PrecacheModel("models/Flyboi/UH1YVenom/uh1yvenom_fb.mdl")
