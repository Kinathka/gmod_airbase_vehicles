...
function ENT:CreateRotors()
	self.Rotors.Front = ents.Create( "avehicle_huey_rotor" )
	...
	self.Rotors.Front:SetPos(self.Entity:GetPos() + (self.Entity:GetUp() * 105))
	...
	self.Rotors.Back:SetAngles(self.Entity:GetAngles() + (self.Rotors.Back:GetRight()):Angle() + self.Rotors.Back:GetUp():Angle())
	self.Rotors.Back:SetPos(self.Entity:GetPos() + (self.Entity:GetUp() * 140.5856)  + (self.Entity:GetForward() * -330.2450) + (self.Entity:GetRight() * -4.6)) --330.2450 6.6013 135.5856
	...
	--Constraint prop
	constraint.Axis( self.Entity, self.Rotors.Front, 0, 0, Vector(0,0,0), Vector(0,0,0) , 0, 0, 1, 1)	
	constraint.Axis( self.Entity, self.Rotors.Back, 0, 0, Vector(-330.2450,-4.6,140.5856) , Vector(0,0,0), 0, 0, 1, 1)
...
function ENT:StartupMotion()
	...
	if IsValid(self.Rotors.Back) then
		local phys = self.Rotors.Back:GetPhysicsObject()
		if phys:IsValid() then
			phys:AddAngleVelocity(Vector(0,0, (self.Rotors.BackSpeed * 0.05)) )
		end
	end
end
