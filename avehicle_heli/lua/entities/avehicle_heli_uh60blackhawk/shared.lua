...
ENT.PrintName		= "Heli UH60 Blackhawk"
ENT.Author			= "Warkanum"
ENT.Category		= "AVehicles"
ENT.EntityName 		= "avehicle_heli_uh60blackhawk"
ENT.Spawnable		= true
...
ENT.AVHardPoints = {
	{id=0,kind=AVehicles.Types.HARDPOINT_AIMABLE,pos=Vector(152, 0, 20),ang=Angle(0,0,0),desc="Center front aimable mount."},
	{id=1,kind=AVehicles.Types.HARDPOINT_AIMABLE,pos=Vector(116, -12, 20),ang=Angle(0,0,0),desc="Center right below aimable mount."},

	{id=2,kind=AVehicles.Types.HARDPOINT_AIMABLE,pos=Vector(55, -55, 55),ang=Angle(0,0,180),desc="Passenger right aimable mount.",pod=2}, --Force hp to pod 2
	{id=3,kind=AVehicles.Types.HARDPOINT_AIMABLE,pos=Vector(55, 55, 55),ang=Angle(0,0,-180),desc="Passenger left aimable mount.",pod=3}, --Force hp to pod 3
	
	{id=4,kind=AVehicles.Types.HARDPOINT_UNIVERSAL,pos=Vector(90, 57, 40),ang=Angle(0,0,0),desc="Front left static universal mount."},
	{id=5,kind=AVehicles.Types.HARDPOINT_UNIVERSAL,pos=Vector(90, -57, 40),ang=Angle(0,0,0),desc="Front right static universal mount."},

	{id=6,kind=AVehicles.Types.HARDPOINT_AIMABLE,pos=Vector(-40, -40, 38),ang=Angle(0,0,180),desc="Back Passenger right aimable mount.",pod=9}, --Force hp to pod 9
	{id=7,kind=AVehicles.Types.HARDPOINT_AIMABLE,pos=Vector(-40, 40, 38),ang=Angle(0,0,-180),desc="BackPassenger left aimable mount.",pod=8}, --Force hp to pod 8

	{id=10,kind=AVehicles.Types.HARDPOINT_HOOK,pos=Vector(4, 0,22),ang=Angle(0,0,0),desc="Hook, Pickup mount"},
...
ENT.PodPositions[0].Position = Vector(103,-22,48)
ENT.PodDesc[0] = {}
ENT.PodDesc[0].Type = 0
ENT.PodDesc[0].Model = "models/nova/airboat_seat.mdl"
...
ENT.PodPositions[1].Position = Vector(103,22,48)
ENT.PodDesc[1] = {}
ENT.PodDesc[1].Type = 0
ENT.PodDesc[1].Model = "models/nova/airboat_seat.mdl"
...
ENT.PodPositions[2].Position = Vector(40,-15,40)
ENT.PodDesc[2] = {}
ENT.PodDesc[2].Type = 0
ENT.PodDesc[2].Model = "models/nova/airboat_seat.mdl"
ENT.PodDesc[2].Visable = true
ENT.PodDesc[2].Collision = false
--Passenger3
ENT.PodPositions[3] = {}
ENT.PodPositions[3].Angles = Angle(0,0,0)
ENT.PodPositions[3].Position = Vector(40,15,40)
ENT.PodDesc[3] = {}
ENT.PodDesc[3].Type = 0
ENT.PodDesc[3].Model = "models/nova/airboat_seat.mdl"
ENT.PodDesc[3].Visable = true
ENT.PodDesc[3].Collision = false

--Passenger4
ENT.PodPositions[4] = {}
ENT.PodPositions[4].Angles = Angle(0,-90,0)
ENT.PodPositions[4].Position = Vector(12,25,40)
ENT.PodDesc[4] = {}
ENT.PodDesc[4].Type = 0
ENT.PodDesc[4].Model = "models/nova/airboat_seat.mdl"
ENT.PodDesc[4].Visable = true
ENT.PodDesc[4].Collision = false
--Passenger5
ENT.PodPositions[5] = {}
ENT.PodPositions[5].Angles = Angle(0,-90,0)
ENT.PodPositions[5].Position = Vector(12,-25,40)
ENT.PodDesc[5] = {}
ENT.PodDesc[5].Type = 1
ENT.PodDesc[5].Model = "models/nova/airboat_seat.mdl"
...
ENT.PodPositions[6].Position = Vector(12,10,40)
ENT.PodDesc[6] = {}
ENT.PodDesc[6].Type = 1
ENT.PodDesc[6].Model = "models/nova/airboat_seat.mdl"
ENT.PodDesc[6].Visable = true
ENT.PodDesc[6].Collision = false
--Passenger7
ENT.PodPositions[7] = {}
ENT.PodPositions[7].Angles = Angle(0,-90,0)
ENT.PodPositions[7].Position = Vector(12,-10,40)
ENT.PodDesc[7] = {}
ENT.PodDesc[7].Type = 1
ENT.PodDesc[7].Model = "models/nova/airboat_seat.mdl"
...
ENT.PodPositions[8].Position = Vector(-60,25,40)
ENT.PodDesc[8] = {}
ENT.PodDesc[8].Type = 1
ENT.PodDesc[8].Model = "models/nova/airboat_seat.mdl"
ENT.PodDesc[8].Visable = true
ENT.PodDesc[8].Collision = false
--Passenger9
ENT.PodPositions[9] = {}
ENT.PodPositions[9].Angles = Angle(0,-90,0)
ENT.PodPositions[9].Position = Vector(-60,-25,40) 
ENT.PodDesc[9] = {}
ENT.PodDesc[9].Type = 1
ENT.PodDesc[9].Model = "models/nova/airboat_seat.mdl"
ENT.PodDesc[9].Visable = true
ENT.PodDesc[9].Collision = false
--Passenger10
ENT.PodPositions[10] = {}
ENT.PodPositions[10].Angles = Angle(0,-90,0)
ENT.PodPositions[10].Position = Vector(-60,10,40)
ENT.PodDesc[10] = {}
ENT.PodDesc[10].Type = 1
ENT.PodDesc[10].Model = "models/nova/airboat_seat.mdl"
ENT.PodDesc[10].Visable = true
ENT.PodDesc[10].Collision = false
--Passenger11
ENT.PodPositions[11] = {}
ENT.PodPositions[11].Angles = Angle(0,-90,0)
ENT.PodPositions[11].Position = Vector(-60,-10,40)
ENT.PodDesc[11] = {}
ENT.PodDesc[11].Type = 1
ENT.PodDesc[11].Model = "models/nova/airboat_seat.mdl"
ENT.PodDesc[11].Visable = true
...
------------------------------------------------------------------------------------Models-----------------------------------------------------------------------------
ENT.Models = {
				Base="models/Flyboi/blackhawk/blackhawk_fb.mdl",
				RotorBase="models/Flyboi/blackhawk/blackhawkrotorm_fb.mdl",
				RotorTail="models/Flyboi/blackhawk/blackhawkrotort_fb.mdl",
			}
ENT.GibsModels = {
...
util.PrecacheModel("models/Flyboi/blackhawk/blackhawk_fb.mdl")
