...
function EFFECT:Init(data)
	...
	--fire puff
		for i=1,math.ceil(self.Scale*25) do
			...
			particle:SetColor(Color(0,0,255,255))
	...
	--flying embers	
		for i=1,math.ceil(math.Rand(10,16)*self.ScaleSlow) do
			...
			particle:SetColor({255,180,100,255})
...
render.DrawSprite(self.Position2,7000*self.GlowSize,5500*self.GlowSize,Color(10,10,250,self.GlowAlpha))


	if self.FlashAlpha > 0 then
		render.SetMaterial(tMats.Glow2)
		render.DrawSprite(self.Position2,self.FlashSize,self.FlashSize,Color(5,5,250,self.FlashAlpha))
	end
